#!/usr/bin/env python3
"""DEPRECATED: Debug script for Alpha-Gen CLI.
...
if __name__ == "__main__":
    ...
    print("")
    print("For CLI commands, use:")
    print("  python -m alphagen run          # Start the real-time service")
    print("  python -m alphagen report       # Display daily P/L summary")
    print("  python -m alphagen debug        # Start unified debug GUI")
    print("")
