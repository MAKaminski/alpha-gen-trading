...
class TestSignalEngineComprehensive:
    ...
    @pytest.mark.asyncio
    async def test_handle_tick_zero_crossover_emits_signal(self, signal_engine, sample_tick):
    ...
    @pytest.mark.asyncio
    async def test_handle_tick_negative_to_positive_crossover(self, signal_engine, sample_tick):
